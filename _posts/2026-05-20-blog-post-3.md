...
# Privacy theories reference — Synthetic Audiences

A skimmable reference covering all ten theories underpinning the _Synthetic Audiences_ study. Each section preserves the full definition, mechanism, example, and implication as originally written, followed by a mind map you can glance at without re-reading the prose.

**A note on ordering.** The theories below are arranged into the same five functional layers used across the project's other diagrams — umbrella phenomenon, structural macro-models, process models, normative framework, and cognitive substrate — rather than the order they were first written in. This keeps the document consistent with the accompanying PNGs and groups theories that build on one another next to each other (e.g. Heuristics sits beside Dual Process Theory because heuristics are the operating mechanism of System 1).
...
**[All theories — master mind map](#all-theories--master-mind-map)**
...
![Privacy decision making mind map](mindmaps/privacy-decision-making.png)
...
![APCO mind map](mindmaps/apco.png)
...
![Enhanced APCO mind map](mindmaps/enhanced-apco.png)
...
![Privacy calculus mind map](mindmaps/privacy-calculus.png)
...
![Protection motivation theory mind map](mindmaps/pmt.png)
...
![Contextual integrity mind map](mindmaps/contextual-integrity.png)
...
![Dual process theory mind map](mindmaps/dual-process-theory.png)
...
![Privacy heuristics mind map](mindmaps/heuristics.png)
...
![Behavioral economics mind map](mindmaps/behavioral-economics.png)
...
![Prospect theory mind map](mindmaps/prospect-theory.png)

---

## All theories — master mind map

All ten theories in one radial view, color-coded by functional layer (umbrella, structural, process, normative, cognitive substrate). Use this as the entry point when you need to place a single theory in the context of the other nine before diving into its section above.

![Master mind map of all ten privacy theories](mindmaps/master_mindmap.png)
